    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <?= $form->field($modelDanhGia, 'noi_dung')->widget(\dosamigos\tinymce\TinyMce::className(),[
                        'options' => ['rows' => 12],
                        'language' => 'vi',
                        'clientOptions' => [
                            'branding'=> false,
        ...
        <div class="panel-footer">
            ...
            <?= Html::a('<span class="fa fa-reply"></span> Quay lại',['xem-tien-do','id'=>$modelCongViec->id],['class'=>'btn btn-default pull-right'])?>
        </div>
    </div>
    <?php ActiveForm::end(); ?>
</div>
