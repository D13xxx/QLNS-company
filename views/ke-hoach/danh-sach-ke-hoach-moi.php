...
$this->title = 'Kế hoạch - Thông báo mới';
                    ...
                    [
                        ...
                        'buttons'=>[
                            'chuyen-duyet'=>function($url,$data){
                                $url=\yii\helpers\Url::to(['/ke-hoach/chuyen-xu-ly','id'=>$data->id]);
                                return Html::a('<i class="glyphicon glyphicon-share-alt"></i>',$url,['title'=>'Chuyển giao xử lý tới cán bộ']);
                            },
                        ]
                    ],
                ],
