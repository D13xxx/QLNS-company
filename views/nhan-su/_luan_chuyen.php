...
echo GridView::widget([
    ...
    'columns' => [
        ...
        [
            ...
            'template'=>'{luan-chuyen}',
            'buttons'=>[
                'luan-chuyen'=>function($url,$data){
                    $url= \yii\helpers\Url::to(['luan-chuyen','id'=>$data->id]);
                    return \yii\helpers\Html::a('<span class="glyphicon glyphicon-share-alt"></span>',$url,[
                        'title'=>'Luân chuyển cán bộ'
                    ]);
                }
            ]
        ],
