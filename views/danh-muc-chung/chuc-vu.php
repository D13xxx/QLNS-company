...
<div class="chuc-vu-index">
    ...
    <div class="panel panel-primary">
                    ...
                    [
                        ...
                        'buttons'=>[
                            'view'=>function($url,$data){
                                $url=\yii\helpers\Url::to(['/danh-muc-chung/xem-chuc-vu','id'=>$data->id]);
                                return Html::a('<span class="glyphicon glyphicon-eye-open"></span>',$url,['title'=>'Xem chi tiết']);
                            },
                            'update'=>function($url,$data){
                                $url=\yii\helpers\Url::to(['/danh-muc-chung/sua-chuc-vu','id'=>$data->id]);
        ...
        <div class="panel-footer">
            <?= Html::a('<span class="fa fa-plus"></span> Thêm mới', ['/danh-muc-chung/them-chuc-vu'], ['class' => 'btn btn-success']) ?>
        </div>
    </div>
