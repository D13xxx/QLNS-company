                        ...
                        <?= GridView::widget([
                            ...
                            'columns'=>[
                                ...
                                [
                                    ...
                                    'contentOptions'=>['style'=>'text-align:center; vertical-align: middle'],
                                    'value'=>function($data){
                                        $congViec=\app\models\CongViec::find()->where(['id'=>$data->cong_viec_id])->one();
                                        if($congViec->trang_thai==CongViec::CV_DAHOANTHANH){
                                            return '';
                                        } else {
                                            if($congViec->nguoi_thuc_hien==Yii::$app->user->id){
                                                return "";
                                            } else {
                                                if($congViec->nguoi_lap==Yii::$app->user->id){
                                                    $url=\yii\helpers\Url::to(['danh-gia-tien-do','id'=>$data->id]);
                                                    return Html::a('<span class="glyphicon glyphicon-saved"></span> Đánh giá',$url,[
